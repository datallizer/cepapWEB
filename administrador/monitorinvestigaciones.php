                ...
                <table class="table table-bordered table-striped" style="width: 100%;">
                    ...
                    <tbody>
                        <?php 
                            ...
                            if(mysqli_num_rows($query_run) > 0)
                            {
                                foreach($query_run as $registro)
                                {
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <a href="../investigacion.php?id=<?= $registro['id']; ?>" class="btn btn-info btn-sm">Ver</a>
                                            
                                            <a href="editarinvestigacion.php?id=<?= $registro['id']; ?>" class="btn btn-success btn-sm">Editar</a>
                                            <form action="codeinvestigaciones.php" method="POST" class="d-inline">
                            ...
                            {
                                echo "<td><h5> No hay investigaciones disponibles por el momento </h5></td><td></td><td></td><td></td>";
                            }
                        ?>
